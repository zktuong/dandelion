...
![](https://github.com/zktuong/dandelion/tree/master/notebooks/img/dandelion_overview.png)

Illustration of the `Dandelion` class slots

![](https://github.com/zktuong/dandelion/tree/master/notebooks/img/dandelion_class.png)
