...
def parse_args():
	...
	parser.add_argument('--sep', type=str, default=None, help='The separator to place between the barcode and prefix/suffix. Only used if a prefix/suffix is provided.')
