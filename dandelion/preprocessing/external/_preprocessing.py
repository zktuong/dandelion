...
def assigngenes_igblast(
    ...
    igblast_db : str | Path | None, optional
...
def makedb_igblast(
    fasta: str | Path,
    igblast_output: str | Path | None = None,
    ...
    igblast_output : str | Path | None, optional
...
def parsedb_heavy(airr_file: str | Path):
    """
...
def parsedb_light(airr_file: str | Path):
    """
...
def tigger_genotype(
    ...
    airr_file : str | Path
        path to AIRR tsv file.
    v_germline : str | Path | None, optional
