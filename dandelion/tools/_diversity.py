...
def clone_rarefaction(
    ...
    -------
    dict[str, float]
        Dictionary of rarefaction results.
    """
...
def clone_diversity(
    ...
    **kwargs
    ...
    -------
    pd.DataFrame
        pandas DataFrame holding diversity information. Afternatively, if `update_obs_meta` is False, `Dandelion` or `AnnData` object is updated in-place.
    """
