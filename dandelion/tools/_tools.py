...
def find_clones(
    ...
    if os.path.isfile(str(vdj_data)):
        write_airr(dat_, vdj_data.parent / (vdj_data.stem + "_clone.tsv"))
    ...
    if isinstance(vdj_data, Dandelion):
        ...
        if vdj_data.threshold is not None:
            ...
            threshold_ = None
        if ("clone_id" in vdj_data.data) and (key_added is None):
        ...
        elif ("clone_id" in vdj_data.data) and (key_added is not None):
            vdj_data.__init__(
                data=dat_,
                germline=germline_,
                layout=layout_,
