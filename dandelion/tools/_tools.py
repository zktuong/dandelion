...
# @Last Modified time: 2021-01-30 12:03:49
...
def transfer(self, dandelion, expanded_only=False, neighbors_key = None, rna_key = None, bcr_key = None, overwrite = None):
    ...
    for x in dandelion.metadata.columns:
        if x not in self.obs.columns:
            ...
            if dandelion.metadata[x].dtype == str or dandelion.metadata[x].dtype == object or dandelion.metadata[x].dtype == 'category' or dandelion.metadata[x].dtype == bool:
